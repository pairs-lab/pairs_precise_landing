...
# dependency .debs from /prebuilt, then builds pairs_precise_landing and copies the .deb to /output.
#   PAIRS deps (build order, supplied from /prebuilt): pairs_lib pairs_msgs
set -eo pipefail
ROS_DISTRO_NAME="noetic"; OS_NAME="ubuntu"; OS_VERSION="focal"
source "/opt/ros/${ROS_DISTRO_NAME}/setup.bash"
set -u

LOCAL_RULES="/src/pairs_precise_landing/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_precise_landing
